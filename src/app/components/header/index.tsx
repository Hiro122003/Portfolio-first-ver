...
import { MenuItem } from '@/app/utils/type';
...
export default function Header() {
  ...
  useEffect(() => {
    window.addEventListener('scroll', handleStickyNaver);
  });

  return (
    <div>
      <header
        className={`top-0 left-0 w-full items-center bg-transparent
        ${
          sticky
